...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://changebag.org', 'https://www.changebag.org'] 
    : ['http://localhost:8080', 'http://localhost:8081', 'http://localhost:3000', 'https://changebag.org'], // Allow development and production domains
  credentials: true
}));
